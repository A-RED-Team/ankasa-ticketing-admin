...
import { getDetailCountry, update } from '../../redux/actions/country';
...
const edit = () => {
  ...
  const { detailCountry } = useSelector((state) => state);
  ...
  useEffect(() => {
    if (detailCountry.data) {
      setForm({
        nameCountry: detailCountry.data.name,
        aliasCountry: detailCountry.data.alias
      });
    }
  }, [detailCountry]);
  ...
  return (
    <>
      <ContentHeader title="Edit Country" />
      {/* Main content */}
